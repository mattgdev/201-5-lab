...
is the product of those numbers, and the second element is a string that EXACTLY follows this example and concatenates
 a message using the arguments passed into the function:
...
/////////////////////////////////////
/* Problem 3
You may not use the arithmetic operators + and * in this function. To do addition,
use your sum() function, and to do multiplication, use your multiply() function that
 you've already created. You're going to have to be resourceful to figure out how to
 do this.
...
arguments and returns an array where the first element is the sum of those three
 numbers, the second element is the product of those three numbers,  and the third
  and fourth elements are strings that EXACTLY follow this example and concatenates
  messages using the arguments that were passed into the function:
...
function sumArray(testArray) { //eslint-disable-line
  var extra = testArray[0];
  for(var i=0; i<testArray.length;i++){
    testArray[0] = sum(testArray[0],testArray[i])[0];
  }
  testArray[0] -= extra;
  //                                                 "2,3,4 was passed in as an array of numbers, and 9 is their sum."
  var message = extra+","+testArray[1]+","+testArray[2] + " was passed in as an array of numbers, and " + testArray[0] + " is their sum.";

  return [testArray[0] , message];
}
...
Test this function by hand in the console to get it working, and when you think it is finished, uncomment the call for the testMultiplyArray() function and see if
the test passes.*/
...
function multiplyArray(testArray) { //eslint-disable-line
  ...
  var secondStep = multiply(testArray[2],firstStep)[0];
  var message = "The numbers " + testArray[0]+","+testArray[1]+","+testArray[2]+ " have a product of " +secondStep  +".";
  return[testArray[0], message];
}
